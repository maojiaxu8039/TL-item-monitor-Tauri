...
pub async fn get_season_api_config(
    ...
    let row: Option<(String, String, String, String, i32, i32)> = sqlx::query_as(
        "SELECT qiandao_tag_id_normal, qiandao_spec_id_normal, qiandao_tag_id_expert, qiandao_spec_id_expert, luosi_season_id_normal, luosi_season_id_expert
    ...
    Ok(match row {
        Some((tgn, spn, tge, spe, ln, le)) => SeasonApiConfig {
...
pub async fn set_season_api_config(
    ...
    sqlx::query(
        "INSERT INTO season_api_configs (season_id, qiandao_tag_id_normal, qiandao_spec_id_normal, qiandao_tag_id_expert, qiandao_spec_id_expert, luosi_season_id_normal, luosi_season_id_expert, created_at, updated_at)
         VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?)
